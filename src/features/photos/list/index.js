...
import {
  ...
  // selectAllPhotos, // TEMPORARILY COMMENTING OUT FOR TESTING IN DEVELOPMENT
...
export default function PhotosList() {
  ...
  // const photos = useSelector(selectAllPhotos); // TEMPORARILY COMMENTING OUT FOR TESTING IN DEVELOPMENT
